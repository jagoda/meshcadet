...
3. **Lock discipline.** An `esp_pm_lock` of type `ESP_PM_NO_LIGHT_SLEEP` must
   ...
   ACTIVE window (`firmware/src/gps.rs:934`–`939`, `GpsDriver::poll`'s "State
   transitions" doc). Anywhere a peripheral
