...
## [0.8.0](https://github.com/jagoda/meshcadet/compare/v0.7.0...v0.8.0) (2026-09-25)
...
* **battery:** show Unknown until the first peak window settles ([388ae86](https://github.com/jagoda/meshcadet/commit/388ae8630d91234f0e618d73f6d46dc1afb86866))
* **battery:** show Unknown until the first peak window settles, not a boot-time sag ([e30b026](https://github.com/jagoda/meshcadet/commit/e30b026d27d1d4a94a9f4b8b622612a6a1c70539))
...
* **docs:** drop internal-ops doc reference from battery_confirmed comment ([627e2f7](https://github.com/jagoda/meshcadet/commit/627e2f72aef58f7391009f8d8f6af0f1742278a5))
...
* **docs:** remove internal-ops vocabulary leak in connect verification kit ([ef02033](https://github.com/jagoda/meshcadet/commit/ef020330f943d6d90ded3d2b77356198edd01124))
...
* **firmware/admin-server:** raise stack budget, heap-allocate card_buf, add QUERY_ADVERT HWM sample ([fb5ad7b](https://github.com/jagoda/meshcadet/commit/fb5ad7bc075ba60aa6f7e7f935f0b126652dbaa5))
* **firmware/dev-flash:** dedupe precondition checks, fix vocabulary leak in test ([eac8bae](https://github.com/jagoda/meshcadet/commit/eac8baecd78328252ba6b712f0a7440f4a0e3c9f))
* **firmware/dev-flash:** write the project's own bootloader, not espflash's stale bundled one ([c624cec](https://github.com/jagoda/meshcadet/commit/c624cecdbd5c2be477f60d3ce9626161063ff3fc))
* **firmware/host:** reject oversized plen at the candidate; add host-CLI open() timing marker ([0cd847f](https://github.com/jagoda/meshcadet/commit/0cd847f6f4d7c92ed793931677c317841d1012f6))
* **firmware:** close the 64-byte-multiple USB packet hazard ([773380e](https://github.com/jagoda/meshcadet/commit/773380edcd94d44e7a1ef2ac23a4ca9760a63c84))
...
* **firmware:** drop internal knowledge-base path reference from rx_loop_guard comments and reformat test assertion ([e80e69a](https://github.com/jagoda/meshcadet/commit/e80e69a75b695a75bd923a7c4b305e730fed693a))
* **firmware:** extract RX-buffer-full flush guard into shared firmware-core helper ([2661934](https://github.com/jagoda/meshcadet/commit/266193497e02a1bacb12d2ad5abdcc1583838b7d))
* **firmware:** extract RX-buffer-full flush guard into shared firmware-core helper ([251f1ee](https://github.com/jagoda/meshcadet/commit/251f1ee804c91352edb4c063f2660eab944294c2))
* **firmware:** flush admin_server's RX buffer when stuck on a false frame magic ([b48046d](https://github.com/jagoda/meshcadet/commit/b48046daedc168db2960a154d6003d906f9666c9))
* **firmware:** flush admin_server's RX buffer when stuck on a false frame magic ([fb546c9](https://github.com/jagoda/meshcadet/commit/fb546c9d34fd513a29e051a0822a5e8fe3eee2df))
...
* **host,site,docs:** bound send-path flush, arrived-vs-retained byte reporting, kit round 6 ([4c2067c](https://github.com/jagoda/meshcadet/commit/4c2067cc85e354a4c07b79bf84bfb89dea42a41e))
* **host/provisioner:** retract re-enumeration mechanism, fix descriptor leak, restore accurate host-side wedge guidance ([6c5b81b](https://github.com/jagoda/meshcadet/commit/6c5b81b43cccc9de15ba744df439e38e7191f881))
* **host/provisioner:** retract re-enumeration mechanism, fix descriptor leak, restore accurate host-side wedge guidance ([5b6a293](https://github.com/jagoda/meshcadet/commit/5b6a2938b27f82455a5763e46b46fb8ea96dbdc8))
* **host:** bound SerialTransport::send so tcdrain can never hang forever ([8d673ee](https://github.com/jagoda/meshcadet/commit/8d673ee8f0dd9c6815de3de32d59ed8c53ca092e))
* **host:** recover from a connect-triggered device reset instead of erroring out ([12d17ee](https://github.com/jagoda/meshcadet/commit/12d17ee003b2762693790302f2eacd0d762e4a4e))
* **host:** stop instructing a disproven unplug-replug remedy on timeout ([6cadbf0](https://github.com/jagoda/meshcadet/commit/6cadbf0c961bd68a2f17ae694e58d6c6741c1b46))
...
* **protocol:** add battery_level/battery_confirmed to RspStatusPayload ([251c3f9](https://github.com/jagoda/meshcadet/commit/251c3f9e7fc5fd5b733f8979ad699ca5ea966fd2))
* **protocol:** add battery_level/battery_confirmed to RspStatusPayload ([cd61d85](https://github.com/jagoda/meshcadet/commit/cd61d85d3154b404bc5ea825094e1bf4e7a4ee23))
...
* **protocol:** reject ADD_CHANNEL frames with an invalid key_len ([92ab76c](https://github.com/jagoda/meshcadet/commit/92ab76c95601604907baf93f6cc483ae92e45593))
* **protocol:** reject ADD_CHANNEL frames with an invalid key_len ([e505d56](https://github.com/jagoda/meshcadet/commit/e505d5646699db12ec7f3f616b396c96dbe2d89c))
...
* **provisioner:** close connect-wedge campaign — bootloader skew, admin_server overflow, DTR/RTS reset ([8dd22d0](https://github.com/jagoda/meshcadet/commit/8dd22d005cbdeafd816fd625f2c7ff2b3e11daa0))
* **provisioner:** de-assert DTR/RTS on connect and tolerate a reset it can't prevent ([3159799](https://github.com/jagoda/meshcadet/commit/3159799a21a1f3c5ec9980cc42677144bbe6674c))
* **provisioner:** de-assert DTR/RTS on connect and tolerate a reset it can't prevent ([2238ba6](https://github.com/jagoda/meshcadet/commit/2238ba68432bed009690079ae660cceecf7e07d0))
* **provisioner:** drop RTS before DTR to stop ESP32-S3 DTR=0/RTS=1 core-reset on connect ([86746ca](https://github.com/jagoda/meshcadet/commit/86746ca2a8770f2bb7bd5f271c8b368e425a3370))
* **provisioner:** recover from connect-triggered device reset (round 7 — root cause confirmed) ([0813aba](https://github.com/jagoda/meshcadet/commit/0813abaf96064825f3e6ce8c2647bef45dfc8066))
* **provisioner:** report arrived (not retained) bytes per attempt + hex-dump discarded noise ([51a6952](https://github.com/jagoda/meshcadet/commit/51a6952e50cde6f3d1adf220fd1056c7ccd95424))
* **provisioner:** report reboot count and reconnect action on timeout ([12510dc](https://github.com/jagoda/meshcadet/commit/12510dcc12e3fc261a36cf891d91808da127db74))
* **provisioner:** revert connect() to open() only, preserve accBuf across retries ([2593a1d](https://github.com/jagoda/meshcadet/commit/2593a1d3255722e845424e54a17bcf02c96c600d))
* **provisioner:** revert setSignals, close retry-boundary byte loss and a 64-byte USB hazard ([76d380d](https://github.com/jagoda/meshcadet/commit/76d380d5daa0764d37bbfa891092e8908022318b))
* **provisioner:** stop touching DTR/RTS after open() to avoid a device wedge ([7b29059](https://github.com/jagoda/meshcadet/commit/7b290595d7c94485377659a162ff5dbbf13e810d))
* **provisioner:** stop touching DTR/RTS after open() to avoid a device wedge ([dbb23fd](https://github.com/jagoda/meshcadet/commit/dbb23fd97c6117954925443f6ee85acbb2a770a2))
* **provisioning:** re-diagnose connect wedge from receive side (round 5) — oversized-plen guard + open() timing marker ([67e1f92](https://github.com/jagoda/meshcadet/commit/67e1f92fea1038b4b84e6eb31f1f8411e64da232))
...
* **firmware:** retract admin_server RX log-noise mechanism, keep the hardening ([a22a4ff](https://github.com/jagoda/meshcadet/commit/a22a4ffe791a4c80a4eb863790417104f43c45e6))
* **firmware:** retract admin_server RX log-noise mechanism, keep the hardening ([40c378f](https://github.com/jagoda/meshcadet/commit/40c378fa34e2b5bb42d6d97558ab8a09b3b09ba2))
* **kit:** close out the connect-wedge campaign ([3edd6bb](https://github.com/jagoda/meshcadet/commit/3edd6bb2e2720c7636e69e7d4ea3f782826684ef))
* **kit:** close out the connect-wedge campaign ([9a394d3](https://github.com/jagoda/meshcadet/commit/9a394d31157810e567b737697f11d0872d179510))
* **kit:** fix stale line-number citations shifted by this round's own edits ([9e62f0b](https://github.com/jagoda/meshcadet/commit/9e62f0b5a61984bd91d17551e283cf34f1603d65))
* **kit:** flag host-side session.rs recv_frame's parallel arrived/retained gap for a future round ([c3afc4c](https://github.com/jagoda/meshcadet/commit/c3afc4c6c4147e6d96cd9ae9ae193f085d4d0441))
* **kit:** record round 11 root cause, retract/re-frame prior rounds ([e5a0ede](https://github.com/jagoda/meshcadet/commit/e5a0edee79b1cf3656dfb0450b63cfcc838215ce))
* **kit:** record round 7's kernel-confirmed root cause and retractions ([97a3a7d](https://github.com/jagoda/meshcadet/commit/97a3a7dfeaa5134de8f027c5870ea4b13718021f))
* **kit:** retract open() finding, correct ST7789 reasoning, record transmit-side diagnosis ([ab2bac8](https://github.com/jagoda/meshcadet/commit/ab2bac8cc56ac470c7df8c1e0e3352855f10f1ae))
* **kit:** retract round 12's premature case-closed framing ([07f19bc](https://github.com/jagoda/meshcadet/commit/07f19bc8f6ba398820cad4a90ef5782c5d024bde))
...
* **provisioning-kit:** evaluate the DFS/idle-screen/on-air-protocol candidates ([0797f1b](https://github.com/jagoda/meshcadet/commit/0797f1b7f6fea75d6ae44900d65e728f8e5c1c86))
* **provisioning:** fix stale snippet, prefix, and retraction gaps in connect kit ([dff6eb1](https://github.com/jagoda/meshcadet/commit/dff6eb12d82641dc7758783317452bdf79d8cfc5))
* **provisioning:** fix stale snippet, prefix, and retraction gaps in connect kit ([6fd34d4](https://github.com/jagoda/meshcadet/commit/6fd34d4a4761fee2f75c232e7b29bfa72ef1761b))
* **provisioning:** round 5 re-diagnosis — confirmed open()-timeout gap, new stuck-candidate hypothesis ([3f06887](https://github.com/jagoda/meshcadet/commit/3f068875f524443df93f3784e9a837c7d4d0838a))
